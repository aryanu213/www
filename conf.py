...
BLOG_AUTHOR = "Bruno Parmentier"  # (translatable)
BLOG_TITLE = "Bruno Parmentier"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.brunoparmentier.be/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://www.brunoparmentier.be/"
BLOG_EMAIL = "bp@brunoparmentier.be"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        #("/blog/archive/index.html", "Archive"),
...
DEPLOY_COMMANDS = {
        'default': [
            "rsync -rav --delete output/ bp@ramnode:~/www/",
        ]
}
...
FAVICONS = {
    ("icon", "/favicon.png", "72x72"),
    ("icon", "/gnome.svg", "any"),
    ("icon", "/favicon.ico", "16x16 32x32 48x48 64x64"),
}
...
# is in the manual.
COMMENT_SYSTEM_ID = "https://www.brunoparmentier.be/comments/"
